...
export const metadata: Metadata = {
  title: "Pollinators — Living Directory",
  description:
    "A social capital activation tool grounded in Ubuntu philosophy. Remember who you know, why they matter, and what we can build together.",
};
